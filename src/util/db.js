...
// Fetch all punchClocks by owner (hook)
export function usePunchClocksByOwner(owner) {
  return useQuery(
    owner && firestore.collection("punch-clock").where("owner", "==", owner)
  );
}

// Fetch punchClock data
export function usePunchClock(id) {
  return useQuery(id && firestore.collection("punch-clock").doc(id));
}

// Update an punchClock
export function updatePunchClock(id, data) {
  return firestore.collection("punch-clock").doc(id).update(data);
}

// Create a new punchClock
export function createPunchClock(data) {
  return firestore.collection("punch-clock").add(data);
}
